...
{	
	...
	NIU_ID_DB_LOC_DB_FUNCTION_CONF,				// 	仪表功能配置
...
NVOID write_local_niu_value_loc(NUINT16 addr_offset,NUINT16 byte_offset,void *databuff,NUINT16 len);
NUINT32 niu_data_write_data_loc(NUINT32 id, NVOID* data);
NUINT32 niu_data_write_data_len_loc(NUINT32 id, NVOID* data, NUINT32 len);
