...
extern "C" {
   ...
   extern bool sidestand_temple_status;
   ...
   // extern void calculate(float poss[][2], int precision, float result[][2]);

   // extern int Test_IIC_ComunicationTask(void);
