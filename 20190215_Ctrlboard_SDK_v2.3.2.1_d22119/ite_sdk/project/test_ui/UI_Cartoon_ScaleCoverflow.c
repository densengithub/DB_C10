...
static ITUIcon *mainCoverFlowIcon[5];;
...
bool MainOnEnter(ITUWidget* widget, char* param)
{
	...
	if (!mainScaleCoverFlow)
	{
		...
		mainCoverFlowIcon[0] = ituSceneFindWidget(&scene, "main0Icon");
		assert(mainCoverFlowIcon[0]);
		mainCoverFlowIcon[1] = ituSceneFindWidget(&scene, "main1Icon");
		assert(mainCoverFlowIcon[1]);
		mainCoverFlowIcon[2] = ituSceneFindWidget(&scene, "main2Icon");
		assert(mainCoverFlowIcon[2]);
		mainCoverFlowIcon[3] = ituSceneFindWidget(&scene, "main3Icon");
		assert(mainCoverFlowIcon[3]);
		mainCoverFlowIcon[4] = ituSceneFindWidget(&scene, "main4Icon");
	...
	ituIconLinkSurface(mainTmpIcon, mainCoverFlowIcon[mainIndex]);
	ituIconLinkSurface(mainCoverFlowIcon[mainIndex], mainNullIcon);
...
bool MainNextBtnOnPress(ITUWidget* widget, char* param)
{
	if (mainIndex != 4){
		...
		ituIconLinkSurface(mainCoverFlowIcon[mainIndex], mainTmpIcon);
		ituSpriteStop(mainPlaySprite[mainIndex]);
