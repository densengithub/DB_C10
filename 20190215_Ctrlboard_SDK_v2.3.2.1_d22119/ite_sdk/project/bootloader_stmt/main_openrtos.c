...
static void* MainTask(void* arg)
{
    ...
    // init lcd
        ...
        ithGpioEnable(CFG_GPIO_LCD_POWER_CTL);
        ithGpioSet(CFG_GPIO_LCD_POWER_CTL);
        ithGpioSetOut(CFG_GPIO_LCD_POWER_CTL); 
        ithPrintf( __TIME__ "ithGpioSet(38) in...\t\n");
        ithDelay(20 * 1000);   
        // ithDelay(40 * 1000);        
        ithGpioClear(38);       
        ithDelay(30 * 1000);
        // ithDelay(100 * 1000);        
        ithPrintf( __TIME__ "ithGpioSet(38) out...\t\n");
        // ithPrintf( LCD_INIT_SCRIPT "...\t\n");
    #else
