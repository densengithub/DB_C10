...
//    ioctl(ITP_DEVICE_SWUART, ITP_IOCTL_INIT, (void*)CFG_SWUART_BAUDRATE);
...
#if defined (CFG_UART_DMA) && !defined(CFG_UPGRADE_FROM_UART)
   ...
   //int swuart_parity;
...
#if (CFG_CHIP_FAMILY != 970 && CFG_CHIP_FAMILY != 960)  //970 and 960 using this code will hang it.
    ...
    ithPrintf("Release:" __DATE__ " " __TIME__ "\r\n");
}
