...
PayloadType payload_type_pcmu8000={
    ...
    CLOCK_RATE(CFG_AUDIO_SAMPLING_RATE),
	BITS_PER_SAMPLE(8),
...
PayloadType payload_type_opus8000={
	TYPE( PAYLOAD_AUDIO_CONTINUOUS),
    CLOCK_RATE(8000),
	BITS_PER_SAMPLE(16),
	ZERO_PATTERN( offset0),
...
PayloadType payload_type_opus16000={
	TYPE( PAYLOAD_AUDIO_CONTINUOUS),
    CLOCK_RATE(16000),
	BITS_PER_SAMPLE(16),
	ZERO_PATTERN( offset0),
...
PayloadType payload_type_opus32000={
	TYPE( PAYLOAD_AUDIO_CONTINUOUS),
    CLOCK_RATE(32000),
	BITS_PER_SAMPLE(16),
	ZERO_PATTERN( offset0),
	PATTERN_LENGTH( 1),
	NORMAL_BITRATE(512000),
	MIME_TYPE ("opus"),
	CHANNELS(1)
};

PayloadType payload_type_opus48000={
	TYPE( PAYLOAD_AUDIO_CONTINUOUS),
    CLOCK_RATE(48000),
	BITS_PER_SAMPLE(16),
	ZERO_PATTERN( offset0),
	PATTERN_LENGTH( 1),
	NORMAL_BITRATE(768000),
	MIME_TYPE ("opus"),
	CHANNELS(1)
};
...
PayloadType payload_type_silk_swb={
    ...
    PayloadType payload_type_ts_cam={
        TYPE(PAYLOAD_OTHER),
        CLOCK_RATE(90000),
        BITS_PER_SAMPLE(0),
        ZERO_PATTERN(NULL),
