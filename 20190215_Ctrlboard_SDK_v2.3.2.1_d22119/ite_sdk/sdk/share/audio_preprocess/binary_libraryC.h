...
typedef struct C_MatrixXcf *MatrixXcf;
typedef struct C_MatrixXci64_t *MatrixXci64_t;
typedef struct C_MatrixXi64_t *MatrixXi64_t;

void ICA_Decomposition(double *m1, double *m2, double *result, int L);
void MatrixXcf_CMN(struct C_MatrixXcf *m1, struct C_MatrixXcf *result);
...
void MatrixXcf_set_Ones(struct C_MatrixXcf *m, int rows, int cols);
...
void MatrixXcf_adjoint(const struct C_MatrixXcf *m1, struct C_MatrixXcf *result);
...
void MatrixXcf_pinv(struct C_MatrixXcf *m1, struct C_MatrixXcf *result);
void MatrixXcf_inverse(const struct C_MatrixXcf *m1, struct C_MatrixXcf *result);
