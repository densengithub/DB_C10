 ...
 */ 
static int ft5306_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops ft5306_ops =
{
	ft5306_read,
};

TSAPI struct tslib_module_info *ft5306_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(ft5306_mod_init);
#endif
