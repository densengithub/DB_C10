 ...
 */ 
static int ft6336_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops ft6336_ops =
{
	ft6336_read,
};

TSAPI struct tslib_module_info *ft6336_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(ft6336_mod_init);
#endif
