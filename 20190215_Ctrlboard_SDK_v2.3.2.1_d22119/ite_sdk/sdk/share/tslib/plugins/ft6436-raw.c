 ...
 */ 
static int ft6436_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops ft6436_ops =
{
	ft6436_read,
};

TSAPI struct tslib_module_info *ft6436_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(ft6436_mod_init);
#endif