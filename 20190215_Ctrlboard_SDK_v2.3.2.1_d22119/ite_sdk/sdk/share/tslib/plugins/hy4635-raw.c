 ...
 */ 
static int hy4635_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops hy4635_ops =
{
	hy4635_read,
};

TSAPI struct tslib_module_info *hy4635_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(hy4635_mod_init);
#endif
