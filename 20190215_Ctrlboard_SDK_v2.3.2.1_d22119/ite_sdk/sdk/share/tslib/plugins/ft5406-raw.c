 ...
 */ 
static int ft5406_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops ft5406_ops =
{
	ft5406_read,
};

TSAPI struct tslib_module_info *ft5406_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(ft5406_mod_init);
#endif
