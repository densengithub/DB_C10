 ...
 */ 
static int st1633_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops st1633_ops =
{
	st1633_read,
};

TSAPI struct tslib_module_info *st1633_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(st1633_mod_init);
#endif
