 ...
 */ 
static int zet7235_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops zet7235_ops =
{
	zet7235_read,
};

TSAPI struct tslib_module_info *zet7235_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(zet7235_mod_init);
#endif
