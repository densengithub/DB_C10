...
// +wlHsu
#define ITE_IDX_TABLE_HANDLE    // load AVI index table
// -wlHsu

//#define FILE_READ_IMPROVE
//#define SLEEP_IMPROVE
//#define COPY_LESS_TIMES_IMPROVE
//#define DEBUG_WRITE_FAIL
//#define OPEN_ONE_FILE_ONCE
...
#   undef SEEK_SET
#endif
#define SEEK_SET    PAL_SEEK_SET

#ifdef SEEK_END
#   undef SEEK_END
#endif
#define SEEK_END    PAL_SEEK_END

#ifdef SEEK_CUR
#   undef SEEK_CUR
#endif
#define SEEK_CUR    PAL_SEEK_CUR
...
#define fprintf(a,t,...)
#define mplayer_put_key(a)
#define vo_draw_text(a,b,c)
#define m_struct_free(a,b)
...
#define mp_msg(t,l,m,...)
#define mp_dbg(t,l,...)
#define mp_msg_test(t,l) (0)
#define MSGT_HEADER 0
#define MSGL_V 0
#define MSGL_DBG2 0
#define strncasecmp(a,b,n) _strnicmp(a, b, n)
#define strcasecmp(a,b) _stricmp(a, b)
#define fast_memcpy(a,b,n) memcpy(a, b, n)
#define read(a,b,c) _read(a,b,c)
#define write(a,b,c) _write(a,b,c)
#define lseek(a,b,c) _lseek(a,b,c)
#define setmode(a,b) _setmode(a,b)
#define fileno(a) _fileno(a)
#define usec_sleep(t) PalSleep((t)/1000)
#define GetTimerMS() PalGetClock()

//#define malloc(size)    PalHeapAlloc(PAL_HEAP_DEFAULT, (size))
//#define calloc(n,size)  PalHeapAlloc(PAL_HEAP_DEFAULT, (n)*(size))
//#define memalign(a,b)   PalHeapAlloc(PAL_HEAP_DEFAULT, (b))
...
//#define CONFIGURATION "--enable-runtime-cpudetection --enable-static --yasm="
