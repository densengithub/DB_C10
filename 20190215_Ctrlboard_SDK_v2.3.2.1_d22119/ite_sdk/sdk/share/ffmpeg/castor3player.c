    ...
    default:
        {
            ...
            {
#if (CFG_BUILD_ITV) && (CFG_CHIP_FAMILY == 9850 || CFG_CHIP_FAMILY == 970)  
...
{
    if (media_player && media_player->check_fileplayer_playing && media_player->check_fileplayer_with_audio)
    {
