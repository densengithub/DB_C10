...
static int check_and_fire(CAPTURE_HANDLE* ptDev)
{
...
static int CaptureGetNewFrame(CAPTURE_HANDLE *ptDev ,ITE_CAP_VIDEO_INFO *Outdata)
{
    static int      cap_idx;
