...
#define AUDIO_PLUGIN_MESSAGE_REGISTER    0xD8000238

#define getAudioPluginMessageStatus() ithReadRegA(AUDIO_PLUGIN_MESSAGE_REGISTER) 
#define setAudioPluginMessageStatus(value) ithWriteRegA(AUDIO_PLUGIN_MESSAGE_REGISTER,value) 
#else
