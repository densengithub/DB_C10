...
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(itv)
    ...
    ITE_LINK_LIBRARY_IF_DEFINED(CFG_VIDEO_ENABLE ffmpeg)
...
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(wifi_sdio)
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(wifi_5g)
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(wifi_ftv)
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(wifi_marvell)
...
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(h264_decoder)
ITE_LINK_LIBRARY_IF_DEFINED_CFG_BUILD_LIB(h264_encoder)
...
elseif (DEFINED CFG_DVB_STANDARDS)
    ...
    ITE_LINK_LIBRARY_IF_DEFINED(CFG_TS_DEMUX_ENABLE ts_demuxer)
...
elseif ($ENV{CFG_PLATFORM} STREQUAL openrtos)
    ...
    if (DEFINED CFG_UPGRADE_BOOTLOADER AND DEFINED CFG_BOOTLOADER_ENABLE)
        ...
        elseif (DEFINED CFG_UPGRADE_BOOTLOADER_NOR)
            set(args ${args} --nor-unformatted-data1 ${bootloader_path})
        ...
        elseif (DEFINED CFG_UPGRADE_BOOTLOADER_SD0)
            set(args ${args} --sd0-unformatted-data1 ${bootloader_path})
        ...
        elseif (DEFINED CFG_UPGRADE_BOOTLOADER_SD1)
            set(args ${args} --sd1-unformatted-data1 ${bootloader_path})
    ...
    if (DEFINED CFG_UPGRADE_BOOTLOADER OR DEFINED CFG_UPGRADE_IMAGE OR DEFINED CFG_UPGRADE_DATA)
        ...
        if (DEFINED CFG_NAND_ENABLE AND DEFINED CFG_UPGRADE_NAND_DATA_BY_DISK_IMAGE AND NOT (${CMAKE_PROJECT_NAME} STREQUAL bootloader))
            add_custom_command(
                ...
                POST_BUILD
                COMMAND pkgtool
                ARGS -s ${CFG_UPGRADE_NAND_DISK_IMAGE_SIZE} -o ${CFG_UPGRADE_NAND_DISK_IMAGE_FILENAME} -N ${CFG_UPGRADE_FILENAME} -e ${CFG_UPGRADE_NAND_DISK_SECTOR_SIZE}
            )
