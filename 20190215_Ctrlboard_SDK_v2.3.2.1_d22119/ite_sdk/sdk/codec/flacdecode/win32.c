...
#if !defined(API_V2)
        case DrvDecode_Frame_Lo : break;
        case DrvDecode_Frame_Hi : fprintf(stderr, "%02d:%02d\r", (int)(val/60), (val%60));
...
int MMIO_Read(int reg) {
    ...
    switch(reg) {
        ...
        case DrvDecode_Frame_Lo : return 0;
        case DrvDecode_Frame_Hi : return 0;
