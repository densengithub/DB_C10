...
#else
#include "hdmirx/it6604/mcu.h"
#endif

#include "hdmirx/it6604/typedef.h"

#ifdef SUPPORT_REPEATER
#include "hdmirx/it6604/sha1.h"
#endif
...
//    unsigned int PCLK ; // in 100KHz unit
//    BYTE PixelRep ;
...
//#define HDMI_RX_I2C_SLAVE_ADDR 0x92
...
#ifndef _MCU_8051_
UCHAR Read_Port_UCHAR(unsigned int Port);
ULONG Read_Port_ULONG(unsigned int Port);
UCHAR Write_Port_UCHAR(unsigned int Port,UCHAR uc);
ULONG Write_Port_ULONG(unsigned int Port,ULONG uc);
#endif

void mmphdmirxsetaudiomute(int state);

void mmphdmirxsetaudioforcemute (void);


//void HDMI_SetColorMode (int type);


HDMIRX_API BYTE HDMIRX_ReadI2C_Byte(BYTE RegAddr);
HDMIRX_API SYS_STATUS HDMIRX_WriteI2C_Byte(BYTE RegAddr, BYTE Data);
HDMIRX_API SYS_STATUS HDMIRX_ReadI2C_ByteN(BYTE RegAddr, BYTE *pData, int N);
HDMIRX_API SYS_STATUS HDMIRX_WriteI2C_ByteN(BYTE RegAddr, BYTE *pData, int N);
...
// Interface
///////////////////////////////////////////////////////////
HDMIRX_API void InitHDMIRX(BOOL bFullInit);
HDMIRX_API void Check_HDMInterrupt();
HDMIRX_API BOOL CheckHDMIRX();
HDMIRX_API void SelectHDMIPort(BYTE ucPort);
BYTE GetCurrentHDMIPort();
void PowerDownHDMI();
void Turn_HDMIRX(BOOL bEnable);
BOOL IsHDMIRXInterlace();
HDMIRX_API WORD getHDMIRXHorzTotal();
HDMIRX_API WORD getHDMIRXHorzActive();
HDMIRX_API WORD getHDMIRXHorzFrontPorch();
HDMIRX_API WORD getHDMIRXHorzSyncWidth();
HDMIRX_API WORD getHDMIRXHorzBackPorch();
HDMIRX_API WORD getHDMIRXVertTotal();
HDMIRX_API WORD getHDMIRXVertActive();
HDMIRX_API WORD getHDMIRXVertFrontPorch();
HDMIRX_API WORD getHDMIRXVertSyncToDE();
HDMIRX_API WORD getHDMIRXVertSyncBackPorch();
HDMIRX_API WORD getHDMIRXVertSyncWidth();
HDMIRX_API BYTE getHDMIRXxCnt();
HDMIRX_API void getHDMIRXRegs(BYTE *pData);
HDMIRX_API BYTE getHDMIRXOutputColorMode();
HDMIRX_API BOOL getHDMIRXAudioInfo(BYTE *pbAudioSampleFreq, BYTE *pbValidCh);
HDMIRX_API BYTE getHDMIRXOutputColorDepth();
HDMIRX_API BYTE getHDMIRX_InputColor();
...
HDMIRX_API BOOL IsHDCPOn();
HDMIRX_API BOOL IsHDMIRXHDMIMode();
HDMIRX_API void SetHDMIRXVideoOutputFormat(BYTE bOutputMapping, BYTE bOutputType, BYTE bOutputColorMode);

HDMIRX_API BOOL  GetAVIInfoFrame(BYTE *pData);
HDMIRX_API BOOL  GetAudioInfoFrame(BYTE *pData);
HDMIRX_API BOOL  GetVENDORSPECInfoFrame(BYTE *pData);

HDMIRX_API BYTE getHDMIRXAudioStatus();
HDMIRX_API BOOL getHDMIRXAudioChannelStatus(BYTE ucIEC60958ChStat[]);
void setHDMIRX_HBROutput(BOOL HBR_SPDIF);
void setHDMIRX_SPDIFOutput();
...
BOOL IsHDMIRX_VideoReady() ;
BOOL IsHDMIRX_AudioReady() ;
BOOL IsHDMIRX_VideoOn() ;


void SetHDMIRX_Tri_State_Enable ();
...
#define VIDEO_ON    1
#define VIDEO_AUTO  2
HDMIRX_API BOOL EnableHDMIRXVideoOutput(BYTE Option) ;


#ifdef DEBUG
void DumpHDMIRXReg();
#else
#define DumpHDMIRXReg()
#endif
//////////////////////////////////////////////////////////////////////////////////
...
SYS_STATUS RxHDCPGetBstatus(unsigned int *pBstatus);
...
void Set_HDMIRX_Tri_State_Enable();
void Set_HDMIRX_Tri_State_Disable();

void IT6604_PowerDown(BOOL enable);
