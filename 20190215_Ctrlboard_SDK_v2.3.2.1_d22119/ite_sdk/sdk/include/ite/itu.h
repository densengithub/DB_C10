...
typedef struct
{
 ...
 #if 1
    unsigned int arabicIndices0;    ///< Arabic text indices #0.
    unsigned int arabicIndices1;    ///< Persian text indices #1.
#else
...
typedef struct
{
	...
	int anifitcount;                            ///< The animation count that fit when meter switch value.
    ITUAction actions[ITU_ACTIONS_SIZE];        ///< Actions for events to trigger
