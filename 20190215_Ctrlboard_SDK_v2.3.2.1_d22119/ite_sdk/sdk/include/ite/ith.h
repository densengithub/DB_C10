...
#if (CFG_CHIP_FAMILY == 970 || CFG_CHIP_FAMILY == 960)
/** @defgroup ith_memwrap Memory Wrap
*  @{
*/
...
#if (CFG_CHIP_FAMILY == 960 || CFG_CHIP_FAMILY == 970)
...
{
#if defined(_WIN32) && (CFG_CHIP_FAMILY == 9070 || CFG_CHIP_FAMILY == 9910 || CFG_CHIP_FAMILY == 9850)
	return (char)ithReadShortRegA(port + ITH_UART_RBR_REG);
#else
...
{
    return (uint32_t)(((uint64_t)ithReadRegA(ITH_TIMER_BASE + timer * 0x10 + ITH_TIMER1_CNT_REG) * 1000000 / ithGetBusClock()) + timerTime[timer]);
}
#else
/**
...
#if (CFG_CHIP_FAMILY == 9850 || CFG_CHIP_FAMILY == 970 || CFG_CHIP_FAMILY == 960)
/**
