...
typedef enum
{
	...
	ITH_GPIO_MODE_TX4      = 15, ///< mode for UART TX 4
	ITH_GPIO_MODE_RX4      = 16, ///< mode for UART RX 4
	ITH_GPIO_MODE_TX5      = 17, ///< mode for UART TX 5
	ITH_GPIO_MODE_RX5      = 18, ///< mode for UART RX 5
#endif
} ITHGpioMode;
