...
/**
* Initializes Win32 Com module.
*
* @param 1: Serial Port Number(Win32)
* @param 2: Uart Baudrate(ex: 115200)
* @return 0 (OK), or -1 (ERROR)
*/
int ComInit(int, int);

/**
* Exit Win32 Com module.
*
* @param 1: Serial Port Number(Win32)
*/
void ComExit(int);
...
/**
* Win32 Com Receive Uart module.
*
* @param 1: Serial Port Number(Win32); Device id(openrtos)
* @param 2: Receive uart message
* @param 3: Uart message length you want to receive
* @return Uart message length you receive actully
*/
int UartReceive(int, char *, int);

/**
* Win32 Com Send Uart module.
*
* @param 1: Serial Port Number(Win32); Device id(openrtos)
* @param 2: Send uart message
* @param 3: Uart message length you want to send
* @return Uart message length you send actully
*/
...
typedef enum
{
    ...
    ITP_DEVICE_I2C2          = (68 << ITP_DEVICE_BIT),       //////< I2C2
    ITP_DEVICE_I2C3          = (69 << ITP_DEVICE_BIT),       //////< I2C3
    ITP_DEVICE_ALT_CPU       = (70 << ITP_DEVICE_BIT),       ///< Software peripheral on ALT CPU
	ITP_DEVICE_WIEGANDOUT0   = (71 << ITP_DEVICE_BIT),       ///< Wiegand0
	ITP_DEVICE_WIEGANDOUT1	 = (72 << ITP_DEVICE_BIT),       ///< Wiegand1
	ITP_DEVICE_UART4         = (73 << ITP_DEVICE_BIT),       ///< UART4
    ITP_DEVICE_UART5         = (74 << ITP_DEVICE_BIT),       ///< UART5
	ITP_DEVICE_USBD		     = (75 << ITP_DEVICE_BIT),		 ///< USB Device
	ITP_DEVICE_USBDACM 		 = (76 << ITP_DEVICE_BIT),		 ///< RS232 over USB
	ITP_DEVICE_USBDCONSOLE	 = (77 << ITP_DEVICE_BIT),		 ///< USB Console
    ITP_DEVICE_RISC2         = (78 << ITP_DEVICE_BIT),       ///< RISC2 device
    ITP_DEVICE_RS485_5		 = (79 << ITP_DEVICE_BIT),       ///< RS485_5
    ITP_DEVICE_LAST
} ITPDeviceType;
...
#define ITP_IOCTL_SET_MODE            100   ///< Set decompress mode(0:UCL 1:BRFLZ 2:BRFLZ_COMPRESSION)
#define ITP_IOCTL_SET_BYTE_PER_PIXEL  101   ///< Set decompress mode(BRFLZ_COMPRESSION 1:1-BYTE/PIXEL 2:2-BYTE/PIXEL 4:4-BYTE/PIXEL)
#define ITP_IOCTL_CUSTOM_CTL_ID0      102  ///< For Custom device usage.
#define ITP_IOCTL_CUSTOM_CTL_ID1      103  ///< For Custom device usage.
#define ITP_IOCTL_CUSTOM_CTL_ID2      104  ///< For Custom device usage.
#define ITP_IOCTL_CUSTOM_CTL_ID3      105  ///< For Custom device usage.
#define ITP_IOCTL_CUSTOM_CTL_ID4      106  ///< For Custom device usage.
#define ITP_IOCTL_CUSTOM_CTL_ID5      107  ///< For Custom device usage.
#define ITP_IOCTL_CUSTOM_CTL_ID6      108  ///< For Custom device usage.
#define ITP_IOCTL_CUSTOM_CTL_ID7      109  ///< For Custom device usage.
#define ITP_IOCTL_WIFI_SLEEP_STATUS   110  ///< Wifi get current status of doorbell/ctrlboard sleep mode.
#define ITP_IOCTL_WIFI_STOP_DHCP      111  ///< Wifi do the DHCP stop.
#define ITP_IOCTL_WIFI_GET_NET_DEVICE 112  ///< Wifi get net device 
#define ITP_IOCTL_RESET_ALL_READY     113  ///< Ethernet reset all ready.
#define ITP_IOCTL_NAND_CHECK_REMAP    114  ///< NAND check REMAP flag
#define ITP_IOCTL_UART_STOP_DMA		  115  ///< Stop Uart DMA
#define ITP_IOCTL_CUSTOM_BRIGHTNESS   116  ///< Custom Sets brightness
#define ITP_IOCTL_CUSTOM_INIT         117  ///< Custom lcd init
#define ITP_IOCTL_CUSTOM_UPGRADE      118  ///< Custom lcd upgrade
...
extern const ITPDevice   itpDeviceUart4;          ///< UART #4 device
extern const ITPDevice   itpDeviceUart5;          ///< UART #5 device
...
extern const ITPDevice   itpDeviceI2c2;           ///< I2C #2 device (IT9850 SW IIC)
extern const ITPDevice   itpDeviceI2c3;           ///< I2C #3 device
...
extern const ITPDevice   itpDeviceRS485_5;        ///< RS485_5 device
...
extern const ITPDevice   itpDeviceWiegandout0;    ///< Wiegand #0 device
extern const ITPDevice   itpDeviceWiegandout1;    ///< Wiegand #1 device
...
extern const ITPDevice   itpDeviceRisc2;          ///< Software peripheral on RISC2
extern const ITPDevice   itpDeviceUsbd;           ///< USB gadget device
extern const ITPDevice   itpDeviceUsbdAcm;        ///< RS232 over USB
extern const ITPDevice   itpDeviceUsbdConsole;    ///< USB Console
...
#ifdef CFG_FS_FAT
    uint64_t exbr_start;                /// < Start of 4th partition BR in FAT.
#endif
} ITPPartition;

#ifdef CFG_FS_FAT

#define ITP_FAT_EXBR_SIZE 520                    // < 8 byte address and 512 byte size.
#define ITP_FAT_EXBR_FILE "fat_exbr_recovery"    // < 4th partition BR for recovery.
...
#define	ITP_NAND_BLK_MODE	0x2		///< open ITP NAND device with FTL mode
