...
#define ITH_AUDIO_RESET_DAC_POS         (14u)   // 0: normal; 1: reset
#define ITH_AUDIO_RESET_DAC_MSK         (N01_BITS_MSK << ITH_AUDIO_RESET_DAC_POS)
#define ITH_AUDIO_RESET_I2S_REGS_POS    (13u)   // 0: normal; 1: reset
#define ITH_AUDIO_RESET_I2S_REGS_MSK    (N01_BITS_MSK << ITH_AUDIO_RESET_I2S_REGS_POS)
...
#define ITH_PLL3_PWR_STATE_POS          (15u)   // 0: power on; 1: power off
...
#define ITH_GPIO_HDMI_IIC_SLV_ADDR_POS  (30u)   // 0: 0x98; 0x9A    HDMI IIC Slave ID
#define ITH_GPIO_HDMI_IIC_SLV_ADDR_MSK  (N01_BITS_MSK << ITH_GPIO_HDMI_IIC_SLV_ADDR_POS)
#define ITH_GPIO_IIC_MODE_POS           (28u)   // 0: APB IIC + HDMI IIC
                                                // 1: APB IIC
                                                // 2: HDMI IIC
...
#define ITH_GPIO_HOST_SEL_POS           (4u)    // 0: select by HOST_CFG
                                                // 4: select as GPIO
                                                // 5: select as ARM JTAG
                                                // 6: select as RISC JTAG
                                                // 7: select as ARM+RISC JTAG
#define ITH_GPIO_HOST_SEL_MSK           (N03_BITS_MSK << ITH_GPIO_HOST_SEL_POS)
#define ITH_GPIO_STOR_SEL_POS           (0u)    // 0: NAND interface
                                                // 1: xD interface
                                                // 2: MMC/SD interface
                                                // 3: MS (Config 1) interface
                                                // 4: MS (Config 2) interface
                                                // 5: CF interface
                                                // 6: NOR interface
