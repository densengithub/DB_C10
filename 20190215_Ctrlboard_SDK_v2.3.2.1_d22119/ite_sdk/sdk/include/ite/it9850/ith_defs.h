...
#define ITH_AUDIO_RESET_DAC_POS         (15u)   // 0: normal; 1: reset
#define ITH_AUDIO_RESET_DAC_MSK         (N01_BITS_MSK << ITH_AUDIO_RESET_DAC_POS)
#define ITH_AUDIO_RESET_I2S_REGS_POS    (14u)   // 0: normal; 1: reset
#define ITH_AUDIO_RESET_I2S_REGS_MSK    (N01_BITS_MSK << ITH_AUDIO_RESET_I2S_REGS_POS)
#define ITH_AUDIO_RESET_I2S_TX_POS      (13u)   // 0: normal; 1: reset
#define ITH_AUDIO_RESET_I2S_TX_MSK      (N01_BITS_MSK << ITH_AUDIO_RESET_I2S_TX_POS)
#define ITH_AUDIO_RESET_I2S_RX_POS      (12u)   // 0: normal; 1: reset
#define ITH_AUDIO_RESET_I2S_RX_MSK      (N01_BITS_MSK << ITH_AUDIO_RESET_I2S_RX_POS)
...
#define ITH_GPIO_MISC_SET_REG           0x1A0
#define ITH_GPIO_EN_AHB_SRAM_POS        (24u)   // 0: disable; 1: enable AHBSRAM wishbone path
#define ITH_GPIO_EN_AHB_SRAM_MSK        (N01_BITS_MSK << ITH_GPIO_EN_AHB_SRAM_POS)
