...
static CAP_HDMI_TIMINFO_TABLE HDMI_TABLE [] = {
    //CEA timing
    //Index, HActive, VActive,    HTotal,     VTotal,       FrameRate,                             SkipPattern,  SkipPeriod,     Hpor,     Vpor, Clkdelay        
    { 0,      720,    480,    858,    262, MMP_CAP_FRAMERATE_29_97HZ,        0xF,      0x3,       0,      0,  0xf     },   //480i60
    { 1,      720,    480,    858,    525, MMP_CAP_FRAMERATE_59_94HZ,        0xF,      0x3,       0,      0,  0xf     },   //480P60
    { 2,      720,    576,    864,    312, MMP_CAP_FRAMERATE_25HZ,           0xF,      0x3,       0,      0,  0xf     },   //576i50
    { 3,      720,    576,    864,    625, MMP_CAP_FRAMERATE_50HZ,           0xF,      0x3,       0,      0,  0xf     },   //576P50
    { 4,     1280,    720,   1650,    750, MMP_CAP_FRAMERATE_59_94HZ,        0xF,      0x3,       1,      1,  0xf     },   //720P60
    { 5,     1280,    720,   1980,    750, MMP_CAP_FRAMERATE_50HZ,           0xF,      0x3,       1,      1,  0xf     },   //720P50
    { 6,     1920,   1080,   2200,   1125, MMP_CAP_FRAMERATE_59_94HZ,        0xF,      0x3,       1,      1,  0xf     },   //1080P60
    { 7,     1920,   1080,   2640,   1125, MMP_CAP_FRAMERATE_50HZ,           0xF,      0x3,       1,      1,  0xf     },   //1080P50
    { 8,     1920,   1080,   2200,    562, MMP_CAP_FRAMERATE_29_97HZ,        0xF,      0x3,       1,      1,  0xf     },   //1080i60
    { 9,     1920,   1080,   2640,    562, MMP_CAP_FRAMERATE_25HZ,           0xF,      0x3,       1,      1,  0xf     },   //1080i50
    {10,     1920,   1080,   2750,   1125, MMP_CAP_FRAMERATE_24HZ,           0xF,      0x3,       1,      1,  0xf     },   //1080P24
    {11,      640,    480,    800,    525, MMP_CAP_FRAMERATE_59_94HZ,        0xF,      0x3,       0,      0,  0xf     },   //640p60
    {12,     1920,   1080,   2200,   1125, MMP_CAP_FRAMERATE_29_97HZ,        0xF,      0x3,       1,      1,  0xf     },   //1080P30
    {13,     1920,   1080,   2640,   1125, MMP_CAP_FRAMERATE_25HZ,           0xF,      0x3,       1,      1,  0xf     },   //1080P25
#if 1    
    //VESA timing 
    //Index, HActive, VActive,    HTotal,    VTotal,          FrameRate,                            SkipPattern,  SkipPeriod,   Hpor,      Vpor, Clkdelay 
    {14,      800,    600,   1056,    628, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      1,  0xf     },   //800x600_60P
    {15,     1024,    768,   1344,    806, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       0,      0,  0xf     },   //1024x768_60P
    {16,     1280,    720,   1664,    746, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      1,  0xf     },   //1280X720_60P
    {17,     1280,    768,   1664,    798, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       0,      1,  0xf     },   //1280X768_60P
    {18,     1280,    800,   1440,    823, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      0,  0xf     },   //1280X800_60P
    {19,     1280,    960,   1800,   1000, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      1,  0x8     },   //1280X960_60P
    {20,     1280,   1024,   1688,   1066, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      1,  0x8     },   //1280X1024_60P
    {21,     1360,    768,   1792,    795, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      1,  0xf     },   //1360X768_60P
    {22,     1366,    768,   1500,    800, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      1,  0xf     },   //1366X768_60P
    {23,     1400,   1050,   1864,   1089, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       0,      1,  0xf     },   //1400X1050_60P
    {24,     1440,    900,   1904,    934, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       0,      1,  0x8     },   //1440X900_60P
    {25,     1600,   1200,   2160,   1250, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       1,      1,  0xf     },   //1600X1200_60P
    {26,     1680,   1050,   2240,   1089, MMP_CAP_FRAMERATE_60HZ,           0xF,      0x3,       0,      1,  0xf     },   //1680X1050_60P
#endif
...
static CAP_ADV7180_TIMINFO_TABLE ADV7180_TABLE [] = {
   //Index, HActive, VActive,      Rate,   FrameRate,                         ROIX, ROIY, ROIW,   ROIH,   Hpor,   Vpor,        HStar,              HEnd,      VStar1,         VEnd1,        VStar2,       VEnd2,
    {0,     720,    487,    2997, MMP_CAP_FRAMERATE_29_97HZ,  0,    0,  720,  480,    0,     0, 238 + 32,   1677 + 32,  22 - 7,   261 - 7,   285 - 7,   524 - 7   }, //480i60
    {1,     720,    576,    2500,    MMP_CAP_FRAMERATE_25HZ,  0,    0,  720,  576,    0,     0, 264 + 18,   1703 + 18,  23 - 4,   310 - 4,   336 - 4,   623 - 4   }, //576i50
};
