 ...
 *
 ***************************************************************************/
 #define FAT_MAXVOLUME     26        /* maximum number of volumes */
 #define FAT_MAXTASK       CHILD_MAX /* maximum number of tasks */
 ...
 ***************************************************************************/
 ...
 #define FN_MAXNAME  ( FN_MAXLNAME + 1 )                       /* maximum length of long filename */
#else
...
#if !USE_MALLOC
 #define F_MAXFILES        7    /* maximum number of files */
#endif
...
#define WR_DATACACHE_SIZE 8 /* min. 1 !!!! */


/* Set F_CLUSTERBUFFER to 1 to allocate a dedicated cluster buffer for speeding
 * up overwriting big files in SAFEFAT mode. When MALLOC isn't used the actual
 * size of this buffer for each volume is determined by F_N_CLUSTERBUFFERx - see below. */
#define F_CLUSTERBUFFER   0
...
/****************************************************************************
 *
 * set FAT_ENCRYPTION to 1 to enable AES file encryption
 *
 ***************************************************************************/
#define FAT_ENCRYPTION 0

#if FAT_ENCRYPTION


/* don't change the lines in this block unless you wan't to replace AES128
 * with another AES encryption */
 #include "../api/api_enc_sw_aes.h"

 #define FAT_ENC_KEY_SIZE   AES_128_KEY_LEN     /* encryption key size */

 #define FAT_ENC_BLOCK_SIZE AES_BLOCK_SIZE      /* block size of encryption
                                                 * actual sector size must be a multiple
                                                 * of FAT_ENC_BLOCK_SIZE */
...
/* No. of sectors buffered when copying clusters
 * set this to bigger than 1 to speed up overwriting big files in SAFEFAT mode */
#define F_N_CLUSTERBUFFER1 8
