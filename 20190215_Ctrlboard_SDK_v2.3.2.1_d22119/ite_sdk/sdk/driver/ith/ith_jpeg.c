    ...
    void)
{
	...
	ithSetRegBitA(ITH_HOST_BASE + ITH_VIDEO_CLK1_REG, ITH_EN_XX2CLK_BIT);
	ithSetRegBitA(ITH_HOST_BASE + ITH_VIDEO_CLK1_REG, ITH_EN_DIV_XXCLK_BIT);
	#else
    ...
    void)
{
	...
	ithClearRegBitA(ITH_HOST_BASE + ITH_VIDEO_CLK1_REG, ITH_EN_XX2CLK_BIT);
	ithClearRegBitA(ITH_HOST_BASE + ITH_VIDEO_CLK1_REG, ITH_EN_DIV_XXCLK_BIT);
	#else
...
void ithJpegEnableClock(void)
{
    // enable clock
    #if (CFG_CHIP_FAMILY == 970)
	ithSetRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_W14CLK_BIT);
    ithSetRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_M6CLK_BIT);
    ithSetRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_JCLK_BIT);
	ithSetRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_DIV_JCLK_BIT);
	#else
...
void ithJpegDisableClock(void)
{
    // disable clock
    #if (CFG_CHIP_FAMILY == 970)
    ithClearRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_W14CLK_BIT);
    ithClearRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_M6CLK_BIT);
    ithClearRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_JCLK_BIT);
	ithClearRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_EN_DIV_JCLK_BIT);
    #else
...
{
	#if (CFG_CHIP_FAMILY == 970)
	ithSetRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_JPEG_RST_BIT);
	ithClearRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_JPEG_RST_BIT);
	#else
...
{
	#if (CFG_CHIP_FAMILY == 970)
	ithSetRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_JPEG_REG_RST_BIT);
	ithClearRegBitA(ITH_HOST_BASE + ITH_JPEG_CLK_REG, ITH_JPEG_REG_RST_BIT);
	#else
