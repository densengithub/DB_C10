...
static void ithPwmSetGpioMode(ITHPwm pwm, unsigned int pin)
{
	switch (pwm) {
		...
		case ITH_PWM4:
			...
			ithSetRegBitA(ITH_GPIO_BASE + ITH_GPIO_PWMSEL23_REG, ITH_GPIO_PWM_HIGH_BIT);
			break;
		case ITH_PWM5:
		...
		case ITH_PWM6:
			...
			ithSetRegBitA(ITH_GPIO_BASE + ITH_GPIO_PWMSEL45_REG, ITH_GPIO_PWM_HIGH_BIT);
			break;
	}
}
...
static void ithPwmClearGpioMode(ITHPwm pwm)
{
	switch(pwm) {
		...
		case ITH_PWM3:
			...
			break;
		case ITH_PWM4:
			ithClearRegBitA(ITH_GPIO_BASE + ITH_GPIO_PWMSEL23_REG, ITH_GPIO_PWM_HIGH_BIT);
			break;
		case ITH_PWM5:
			ithClearRegBitA(ITH_GPIO_BASE + ITH_GPIO_PWMSEL45_REG, ITH_GPIO_PWM_LOW_EN_BIT);
			break;
		case ITH_PWM6:
			ithClearRegBitA(ITH_GPIO_BASE + ITH_GPIO_PWMSEL45_REG, ITH_GPIO_PWM_HIGH_BIT);
			break;
	}
}
