...
void ithClockSleep(void)
{
	...
	//APB2
	ithClearRegBitA(ITH_APB_CLK2_REG, ITH_EN_W21CLK_BIT);
	...
	ithClearRegBitA(ITH_RISC_CLK_REG, ITH_EN_N6CLK_BIT);
	ithClearRegBitA(ITH_RISC_CLK_REG, ITH_EN_N5CLK_BIT);
...
{
#if defined(CFG_ITH_FPGA) || (CFG_CHIP_FAMILY == 970) || (CFG_CHIP_FAMILY == 960)
