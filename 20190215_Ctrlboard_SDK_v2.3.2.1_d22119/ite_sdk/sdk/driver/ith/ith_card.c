...
bool ithSdSwitchPin1(int idx)
{
    ...
    #define SET_SD_DATA_MODE(x)     ((x & 0x3) << 0)
    #define SET_SD_CLK_MODE(x)      ((x & 0x3) << 2)
    #define SET_SD_PIN_IDX(x)       ((x & 0xF) << 4) /* 0:D0, ~ 7:D7, 8:CMD */
    #define SET_SDC(idx)            (idx << 8)

    #define GET_SD_DATA_MODE(gpio)  ((sd_gpio_tlb[gpio] >> 0) & 0x3)
    #define GET_SD_CLK_MODE(gpio)   ((sd_gpio_tlb[gpio] >> 2) & 0x3)
    #define GET_SD_PIN_INDEX(gpio)  ((sd_gpio_tlb[gpio] >> 4) & 0xF)
    #define GET_SDC(gpio)           ((sd_gpio_tlb[gpio] >> 8) & 0x1)

#if (CFG_CHIP_FAMILY == 970) || (CFG_CHIP_FAMILY == 960) // only for 960 test chip!!!!!
static uint16_t sd_gpio_tlb[55] = {
    ...
    SET_SDC(1) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(2) | SET_SD_CLK_MODE(3),  // gpio 4
    SET_SDC(0) | SET_SD_PIN_IDX(8) | SET_SD_DATA_MODE(2),                       // gpio 5
    0,                                                                          // gpio 6
    SET_SDC(0) | SET_SD_PIN_IDX(0) | SET_SD_DATA_MODE(2),                       // gpio 7
    SET_SDC(0) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(2),                       // gpio 8
    SET_SDC(0) | SET_SD_PIN_IDX(2) | SET_SD_DATA_MODE(2),                       // gpio 9
    SET_SDC(0) | SET_SD_PIN_IDX(3) | SET_SD_DATA_MODE(2),                       // gpio 10
    SET_SDC(1) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(1) | SET_SD_CLK_MODE(2),  // gpio 11
    SET_SD_CLK_MODE(2),                                                         // gpio 12
    SET_SDC(1) | SET_SD_PIN_IDX(8) | SET_SD_DATA_MODE(2),                       // gpio 13
    0,                                                                          // gpio 14
    SET_SDC(1) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(1) | SET_SD_CLK_MODE(2),  // gpio 15
    SET_SD_CLK_MODE(2),                                                         // gpio 16
    SET_SDC(1) | SET_SD_PIN_IDX(8) | SET_SD_DATA_MODE(2),                       // gpio 17
    0,                                                                          // gpio 18
    0,                                                                          // gpio 19
    0,                                                                          // gpio 20
    0,                                                                          // gpio 21
    ...
    0,                                                                          // gpio 23
    0,                                                                          // gpio 24
    SET_SDC(1) | SET_SD_PIN_IDX(8) | SET_SD_DATA_MODE(2),                       // gpio 25
    SET_SD_CLK_MODE(2),                                                         // gpio 26
    SET_SD_CLK_MODE(2),                                                         // gpio 27
    SET_SDC(1) | SET_SD_PIN_IDX(0) | SET_SD_DATA_MODE(2),                       // gpio 28
    SET_SDC(1) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(2),                       // gpio 29
    SET_SDC(1) | SET_SD_PIN_IDX(2) | SET_SD_DATA_MODE(2),                       // gpio 30
    SET_SDC(1) | SET_SD_PIN_IDX(3) | SET_SD_DATA_MODE(2),                       // gpio 31
    0,                                                                          // gpio 32
    0,                                                                          // gpio 33
    0,                                                                          // gpio 34
    0,                                                                          // gpio 35
    ...
    0,                                                                          // gpio 45
    0,                                                                          // gpio 46
    SET_SDC(1) | SET_SD_PIN_IDX(8) | SET_SD_DATA_MODE(3),                       // gpio 47
    SET_SD_CLK_MODE(3),                                                         // gpio 48
    SET_SDC(1) | SET_SD_PIN_IDX(0) | SET_SD_DATA_MODE(3),                       // gpio 49
    SET_SDC(1) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(3),                       // gpio 50
    SET_SDC(1) | SET_SD_PIN_IDX(2) | SET_SD_DATA_MODE(3),                       // gpio 51
    SET_SDC(1) | SET_SD_PIN_IDX(3) | SET_SD_DATA_MODE(3),                       // gpio 52
    SET_SDC(0) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(3),                       // gpio 53
    SET_SD_CLK_MODE(3)                                                          // gpio 54
};
#else // (CFG_CHIP_FAMILY == 960)
static uint16_t sd_gpio_tlb[55] = {
    SET_SDC(0) | SET_SD_PIN_IDX(4) | SET_SD_DATA_MODE(2),                       // gpio 0
    SET_SDC(0) | SET_SD_PIN_IDX(5) | SET_SD_DATA_MODE(2),                       // gpio 1
    SET_SDC(0) | SET_SD_PIN_IDX(6) | SET_SD_DATA_MODE(2),                       // gpio 2
    ...
    0,                                                                          // gpio 8
    0,                                                                          // gpio 9
    SET_SDC(1) | SET_SD_PIN_IDX(1) | SET_SD_DATA_MODE(2),                       // gpio 10
    SET_SDC(1) | SET_SD_PIN_IDX(8) | SET_SD_DATA_MODE(2),                       // gpio 11
    SET_SD_CLK_MODE(2),                                                         // gpio 12
    ...
    case ITH_STOR_SD:
        {
            ...
            for (i = (SD_PIN_NUM-1); i >= 0; i--) /* clock is the last to switch back */
            {
                ...
                if (num != (unsigned char)-1)
                {
                    ...
                    ithGpioCtrlEnable(  num,    ITH_GPIO_PULL_ENABLE); /* sd io pull up */
                    ithGpioCtrlEnable(  num,    ITH_GPIO_PULL_UP);
					ithGpioSetDriving(num, ITH_GPIO_DRIVING_3);
                }
