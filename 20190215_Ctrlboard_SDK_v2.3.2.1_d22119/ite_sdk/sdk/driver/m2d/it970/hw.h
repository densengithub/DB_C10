...
#define GFX_REG_LINE_P1                     0
#define GFX_REG_LINE_P1_MASK                0x1FFFFF
...
#define GFX_REG_SAFE_WRREORDER_EN           (1 << 19)
#define GFX_REG_SAFE_RDREORDER_EN           (1 << 18)
...
#define GFX_REG_CR1_ALPHA_SEL_DEFAULT       (0x00 << 22)
#define GFX_REG_CR1_ALPHA_SEL_SRC           (0x01 << 22)
#define GFX_REG_CR1_ALPHA_SEL_DST           (0x02 << 22)
#define GFX_REG_CR1_ALPHA_SEL_MAX           (0x03 << 22)
...
#define GFX_REG_CR2_SRCFORMAT_XARGB         (0x12 << 0)
#define GFX_REG_CR2_SRCFORMAT_XABGR         (0x13 << 0)

//  Control Register 3, CR3 (+0x088)
#define GFX_REG_CR3_ADDR                    GFX_REG_BASE_ADDR + 0x0088
#define GFX_REG_CR3_LINE_P2_MASK            0xFFFF
#define GFX_REG_CR3_LINE_P2_OFFSET          16
#define GFX_REG_CR3_LINE_WIDTH_MASK         0xFF
#define GFX_REG_CR3_LINE_WIDTH_OFFSET       8
#define GFX_REG_CR3_LINEALGORITHM_0         (0 << 2)
#define GFX_REG_CR3_LINEALGORITHM_1         (1 << 2)
#define GFX_REG_CR3_LASTPIXEL_EN            (1 << 1)
#define GFX_REG_CR3_LINE_TYPE0              (0 << 0)
#define GFX_REG_CR3_LINE_TYPE1              (1 << 0)
