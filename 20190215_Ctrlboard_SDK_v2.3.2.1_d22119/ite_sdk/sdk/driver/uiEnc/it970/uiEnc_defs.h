...
//=============================================================================
    ...
    // Host
    #define uie_ReadHwReg(add, data)                (*data = ithReadRegA(add))
    #define uie_WriteHwReg(add, data)               ithWriteRegA(add, data)
    #define uie_WriteHwRegMask(add, data, mark)     ithWriteRegMaskA(add, data, mark)
