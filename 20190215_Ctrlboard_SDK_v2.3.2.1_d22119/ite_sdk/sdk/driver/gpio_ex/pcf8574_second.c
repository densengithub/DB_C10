...
#include "gpio_ex/pcf8574_second.h"
#include "ite/ith.h"

//=============================================================================
//                              Constant Definition
//=============================================================================
#define IO_EXPAND_DEV       0x4C >> 1
#define QSIZE        10
...
void IOExpanderDriver_initial_2(void)
{
    ...
    IOExpander_WritePort_2(0xFF);        //default all setting to input mode.
    OldStatus = IOExpander_ReadPort_2(); //save the first GPIO realize status.
}
