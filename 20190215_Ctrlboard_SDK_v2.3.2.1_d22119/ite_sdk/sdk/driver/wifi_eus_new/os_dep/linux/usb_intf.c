...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	/*=== Realtek demoboard ===*/
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x8179), .driver_info = (void *)RTL8188E}, /* 8188EUS */
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x0179), .driver_info = (void *)RTL8188E}, /* 8188ETV */
	/*=== Customer ID ===*/
	/****** 8188EUS ********/
	{USB_DEVICE(0x07B8, 0x8179), .driver_info = (void *)RTL8188E}, /* Abocom - Abocom */
#endif
...
struct rtw_usb_drv {
	...
	int drv_registered;
	u8 hw_type;
	_mutex hw_init_mutex; //eason
};

struct rtw_usb_drv usb_drv = {
	.usbdrv.name = (char *)DRV_NAME,
	.usbdrv.probe = (void *)rtw_drv_init,
...
static int rtw_drv_init(struct usb_interface *pusb_intf, const struct usb_device_id *pdid)
{
	...
	int status = _FAIL, i;
	struct dvobj_priv *dvobj;
	struct usb_device* dev = pusb_intf->usb_dev; //eason
