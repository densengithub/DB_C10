...
#define REG_I2C_DATA_RCV_STATE             (0x20)
...
/*Control Register*/
#define REG_BIT_CONTL_CHECK_DOWN_EN        (1u << 19)
...
/*Status Register*/
#define REG_BIT_STATUS_DATA_END_CLEAR      (1u << 29)
#define REG_BIT_STATUS_CHECK_CLEAR         (1u << 28)
