    ...
    uint32_t    clock)
{
    ...
    do
    {
        ...
        if (IicDevices[port].port == IIC_PORT_0)
        {
            ...
            ithWriteRegA(ITH_GPIO_BASE + 0x238, (1 << 15) | (1 << 31) | (CFG_GPIO_IIC0_CLK << 16) | (CFG_GPIO_IIC0_DATA));
        }
#endif
        ...
        if(IicDevices[port].port == IIC_PORT_1)
        {
             ...
             ithWriteRegA(ITH_GPIO_BASE + 0x23C, (1 << 15) | (1 << 31) | (CFG_GPIO_IIC1_CLK << 16) | (CFG_GPIO_IIC1_DATA));
        }
#endif
        ...
        if(IicDevices[port].port == IIC_PORT_2)
        {
            ...
            ithWriteRegA(ITH_GPIO_BASE + 0x240, (1 << 15) | (1 << 31) | (CFG_GPIO_IIC2_CLK << 16) | (CFG_GPIO_IIC2_DATA));
        }
#endif
        ...
        if(IicDevices[port].port == IIC_PORT_3)
        {
            ...
            ithWriteRegA(ITH_GPIO_BASE + 0x244, (1 << 15) | (1 << 31) | (CFG_GPIO_IIC3_CLK << 16) | (CFG_GPIO_IIC3_DATA));
        }
#endif
#endif
        //Reset HW
