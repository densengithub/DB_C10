...
extern void choose_devnum(struct usb_device* dev);
extern int port_init(struct ehci_hcd* ehci, struct usb_device *udev);

extern int usb_set_configuration(struct usb_device *udev, int config);
