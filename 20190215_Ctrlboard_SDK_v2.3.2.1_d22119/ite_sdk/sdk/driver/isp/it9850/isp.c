...
//=============================================================================
/**
 * ISP dummy color matrix.
 */
//=============================================================================
void
ISP_SetDummyColorMatrix(
    ISP_DEVICE ptDev)
{
    ISP_CONTEXT *pISPctxt = (ISP_CONTEXT *)ptDev;
    ...
    pISPctxt->YUV2RGBFun._11    = 0x0100;
    pISPctxt->YUV2RGBFun._12    = 0x0000;
    pISPctxt->YUV2RGBFun._13    = 0x0000;
    pISPctxt->YUV2RGBFun._21    = 0x0000;
    pISPctxt->YUV2RGBFun._22    = 0x0100;
    pISPctxt->YUV2RGBFun._23    = 0x0000;
    pISPctxt->YUV2RGBFun._31    = 0x0000;
    pISPctxt->YUV2RGBFun._32    = 0x0000;
    pISPctxt->YUV2RGBFun._33    = 0x0100;
    pISPctxt->YUV2RGBFun.ConstR = 0x0000;
    pISPctxt->YUV2RGBFun.ConstG = 0x0000;
    pISPctxt->YUV2RGBFun.ConstB = 0x0000;
    ...
    ISP_DEVICE ptDev)
{
    ...
    {
        if (pISPctxt->EnableYUV2YUV)
            ISP_SetDummyColorMatrix(pISPctxt);
