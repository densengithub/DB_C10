...
//                              Constant Definition
//=============================================================================
#define ISP_REG_BASE                        0xD0300000
#define ISP_CORE_1_BASE                     0x00000200
#define ISP_MASK_LOWBIT                     0xFFFF0000
#define ISP_MASK_HIGHBIT                    0x0000FFFF
...
#define ISP_BIT_SWWRFLIPNUM                 0x0007        //1110 0000 0000 0000
#define ISP_BIT_WRITE_ROTATE_DIR            0x0007        //0001 1100 0000 0000
#define ISP_BIT_WRFLIPNUM                   0x0007        //0000 0011 1000 0000
...
#define ISP_SHT_SWWRFLIPNUM                 (13 + 16)
#define ISP_SHT_WRITE_ROTATE_DIR            (10 + 16)
#define ISP_SHT_WRFLIPNUM                   (7 + 16)
#define ISP_SHT_PROGFIELD_MODE_EN           (6 + 16)
#define ISP_SHT_NEGATIVE_EFFECT_EN          (5 + 16)
#define ISP_SHT_FIELD_SCALE_EN              (4 + 16)
#define ISP_SHT_BOTTOM_FIELD_SCALE_FIRST    (3 + 16)
#define ISP_SHT_COLOR_CORRECT_EN            (2 + 16)
#define ISP_SHT_COLOR_SPECE_EN              (1 + 16)
#define ISP_SHT_VIDEO_OUT_EN                (0 + 16)
...
#define ISP_SHT_IN_YUV255RANGE_EN           (13 + 16)
#define ISP_SHT_IN_PACKET_FORMAT            (10 + 16)
#define ISP_SHT_IN_PLANE_FORMAT             (8 + 16)
#define ISP_SHT_IN_RDRQ_DOUBLE_LINE         (7 + 16)
#define ISP_SHT_IN_RGB888_EN                (5 + 16)
#define ISP_SHT_IN_RGB565_EN                (4 + 16)
#define ISP_SHT_IN_YUVPACKET_EN             (3 + 16)
#define ISP_SHT_IN_YUVPLANE_EN              (2 + 16)
#define ISP_SHT_IN_NV_FORMAT                (1 + 16)
#define ISP_SHT_IN_NV_EN                    (0 + 16)
...
#define ISP_SHT_OUT_RGB_FORMAT              (14 + 16)
#define ISP_SHT_OUT_YUVPACKET_FORMAT        (12 + 16)
#define ISP_SHT_OUT_YUVPLANE_FORMAT         (10 + 16)
#define ISP_SHT_OUT_FORMAT                  (8 + 16)
#define ISP_SHT_OUT_DITHER_MODE             (7 + 16)
#define ISP_SHT_LCD_RGB2YUV_EN              (6 + 16)
#define ISP_SHT_QUEUE_FIRE_EN               (5 + 16)
#define ISP_SHT_KEEP_LAST_FIELD_EN          (4 + 16)
#define ISP_SHT_LCD_ONFLY_EN                (2 + 16)
#define ISP_SHT_ONFLY_WRITE_MEM_EN          (1 + 16)
#define ISP_SHT_DOUBLE_FRAMERATE_EN         (0 + 16)
...
#define ISP_SHT_POST_SUBTITLE_EN            (2 + 16)
#define ISP_SHT_ISP_INTERRUPT_EN            (1 + 16)
#define ISP_SHT_OUTYUV235RANGE_EN           (0 + 16)
...
#define ISP_BIT_INPUT_HEIGHT                0x3FFF          //0111 1111 1111 1111 13:0
#define ISP_BIT_INPUT_WIDTH                 0x7FFF          //0011 1111 1111 1111 14:0
...
#define ISP_REG_SCALE_HCIP_H                (ISP_REG_BASE + 0x0032)   // HCIP
#define ISP_REG_SCALE_VCIP                  (ISP_REG_BASE + 0x0034)   // VCIP
#define ISP_REG_SCALE_OPNPLB                (ISP_REG_BASE + 0x0036)   // OPNPLB
...
#define ISP_BIT_SCALE_HCIP_L                0xFFFF          //1111 1111 1111 1111 15:0
#define ISP_BIT_SCALE_HCIP_H                0x007F          //0000 0000 0111 1111 6:0
#define ISP_BIT_SCALE_VCIP                  0x007F          //0000 0000 0111 1111 6:0
#define ISP_BIT_SCALE_OPNPLB                0x3FFF          //0011 1111 1111 1111 13:0
...
// UV Interpolation
//================================================================
#define ISP_REG_UV_INTERPOLATION            (ISP_REG_BASE + 0x0040)
...
#define ISP_BIT_SUBTITLE_PITCH              0x7FFF          //0111 1111 1111 1111 10:0
...
// Low Latency Slice
//================================================================
#define ISP_REG_LOWLATENCY_SLICE            (ISP_REG_BASE + 0x0072)

#define ISP_BIT_LOWLATENCY_SLICE            0x03FF          //0000 0011 1111 1111 9:0
...
//================================================================
#define ISP_REG_OUT_1_ADDR_0L               (ISP_REG_BASE + 0x0074)
#define ISP_REG_OUT_1_ADDR_0H               (ISP_REG_BASE + 0x0076)
#define ISP_REG_OUT_1_ADDR_1L               (ISP_REG_BASE + 0x0078)
#define ISP_REG_OUT_1_ADDR_1H               (ISP_REG_BASE + 0x007A)
#define ISP_REG_OUT_1_ADDR_2L               (ISP_REG_BASE + 0x007C)
#define ISP_REG_OUT_1_ADDR_2H               (ISP_REG_BASE + 0x007E)
#define ISP_REG_OUT_2_ADDR_0L               (ISP_REG_BASE + 0x0080)
#define ISP_REG_OUT_2_ADDR_0H               (ISP_REG_BASE + 0x0082)
#define ISP_REG_OUT_2_ADDR_1L               (ISP_REG_BASE + 0x0084)
#define ISP_REG_OUT_2_ADDR_1H               (ISP_REG_BASE + 0x0086)
#define ISP_REG_OUT_2_ADDR_2L               (ISP_REG_BASE + 0x0088)
#define ISP_REG_OUT_2_ADDR_2H               (ISP_REG_BASE + 0x008A)
#define ISP_REG_OUT_3_ADDR_0L               (ISP_REG_BASE + 0x008C)
#define ISP_REG_OUT_3_ADDR_0H               (ISP_REG_BASE + 0x008E)
#define ISP_REG_OUT_3_ADDR_1L               (ISP_REG_BASE + 0x0090)
#define ISP_REG_OUT_3_ADDR_1H               (ISP_REG_BASE + 0x0092)
#define ISP_REG_OUT_3_ADDR_2L               (ISP_REG_BASE + 0x0094)
#define ISP_REG_OUT_3_ADDR_2H               (ISP_REG_BASE + 0x0096)
#define ISP_REG_OUT_4_ADDR_0L               (ISP_REG_BASE + 0x0098)
#define ISP_REG_OUT_4_ADDR_0H               (ISP_REG_BASE + 0x009A)
#define ISP_REG_OUT_4_ADDR_1L               (ISP_REG_BASE + 0x009C)
#define ISP_REG_OUT_4_ADDR_1H               (ISP_REG_BASE + 0x009E)
#define ISP_REG_OUT_4_ADDR_2L               (ISP_REG_BASE + 0x00A0)
#define ISP_REG_OUT_4_ADDR_2H               (ISP_REG_BASE + 0x00BE)

#define ISP_REG_OUT_1_ADDR_0L_CORE1         (ISP_REG_BASE + 0x00B6)
#define ISP_REG_OUT_1_ADDR_0H_CORE1         (ISP_REG_BASE + 0x00B8)
#define ISP_REG_OUT_1_ADDR_1L_CORE1         (ISP_REG_BASE + 0x00BA)
#define ISP_REG_OUT_1_ADDR_1H_CORE1         (ISP_REG_BASE + 0x00BC)
#define ISP_REG_OUT_1_ADDR_2L_CORE1         (ISP_REG_BASE + 0x015C)
#define ISP_REG_OUT_1_ADDR_2H_CORE1         (ISP_REG_BASE + 0x015E)
#define ISP_REG_OUT_2_ADDR_0L_CORE1         (ISP_REG_BASE + 0x0160)
#define ISP_REG_OUT_2_ADDR_0H_CORE1         (ISP_REG_BASE + 0x0162)
#define ISP_REG_OUT_2_ADDR_1L_CORE1         (ISP_REG_BASE + 0x01B4)
#define ISP_REG_OUT_2_ADDR_1H_CORE1         (ISP_REG_BASE + 0x01B6)
#define ISP_REG_OUT_2_ADDR_2L_CORE1         (ISP_REG_BASE + 0x01B8)
#define ISP_REG_OUT_2_ADDR_2H_CORE1         (ISP_REG_BASE + 0x01BA)

#define ISP_BIT_WB_OUT_ADDR_L               0xFFFF          //1111 1111 1111 1111 15:0
#define ISP_BIT_WB_OUT_ADDR_H               0xFFFF          //1111 1111 1111 1111 15:0

//================================================================
// weighting matrix of Preview Scale
//================================================================
#define ISP_REG_PVSCALEWX0100               (ISP_REG_BASE + 0x0072)
#define ISP_REG_PVSCALEWX0302               (ISP_REG_BASE + 0x0074)
#define ISP_REG_PVSCALEWX1110               (ISP_REG_BASE + 0x0076)
#define ISP_REG_PVSCALEWX1312               (ISP_REG_BASE + 0x0078)
#define ISP_REG_PVSCALEWX2120               (ISP_REG_BASE + 0x007A)
#define ISP_REG_PVSCALEWX2322               (ISP_REG_BASE + 0x007C)
#define ISP_REG_PVSCALEWX3130               (ISP_REG_BASE + 0x007E)
#define ISP_REG_PVSCALEWX3332               (ISP_REG_BASE + 0x0080)
#define ISP_REG_PVSCALEWX4140               (ISP_REG_BASE + 0x0082)
#define ISP_REG_PVSCALEWX4342               (ISP_REG_BASE + 0x0084)

#define ISP_REG_PVSCALEWY0100               (ISP_REG_BASE + 0x0086)
#define ISP_REG_PVSCALEWY0302               (ISP_REG_BASE + 0x0088)
#define ISP_REG_PVSCALEWY1110               (ISP_REG_BASE + 0x008A)
#define ISP_REG_PVSCALEWY1312               (ISP_REG_BASE + 0x008C)
#define ISP_REG_PVSCALEWY2120               (ISP_REG_BASE + 0x008E)
#define ISP_REG_PVSCALEWY2322               (ISP_REG_BASE + 0x0090)
#define ISP_REG_PVSCALEWY3130               (ISP_REG_BASE + 0x0092)
#define ISP_REG_PVSCALEWY3332               (ISP_REG_BASE + 0x0094)
#define ISP_REG_PVSCALEWY4140               (ISP_REG_BASE + 0x0096)
#define ISP_REG_PVSCALEWY4342               (ISP_REG_BASE + 0x0098)
...
//================================================================
#define ISP_REG_PVOUT_ADDR_0L               (ISP_REG_BASE + 0x009E)
#define ISP_REG_PVOUT_ADDR_0H               (ISP_REG_BASE + 0x00A0)

#define ISP_REG_PVOUT_WIDTH                 (ISP_REG_BASE + 0x009A)
#define ISP_REG_PVOUT_HEIGHT                (ISP_REG_BASE + 0x009C)
#define ISP_REG_PVOUT_YRGB_PITCH            (ISP_REG_BASE + 0x00BE)

#define ISP_BIT_PVOUT_ADDR_L                0xFFFF          //1111 1111 1111 1111 15:0
#define ISP_BIT_PVOUT_ADDR_H                0xFFFF          //1111 1111 1111 1111 15:0
#define ISP_BIT_PVOUT_WIDTH                 0x3FFF          //0011 1111 1111 1111 13:0
#define ISP_BIT_PVOUT_HEIGHT                0x3FFF          //0011 1111 1111 1111 13:0
#define ISP_BIT_PVOUT_PITCH                 0x7FFF          //0111 1111 1111 1111 14:0
...
//================================================================
#define ISP_REG_PVSCALE_DSTWIDTH            (ISP_REG_BASE + 0x00CC)
#define ISP_REG_PVSCALE_DSTHEIGHT           (ISP_REG_BASE + 0x00CE)

#define ISP_BIT_PVSCALE_DSTWIDTH            0x3FFF          //0011 1111 1111 1111 13:0
#define ISP_BIT_PVSCALE_DSTHEIGHT           0x3FFF          //0011 1111 1111 1111 13:0
...
// 0x05FC
//================================================================
#define ISP_REG_PVOUTPUT_FORMAT             (ISP_REG_BASE + 0x00FC)
...
#define ISP_BIT_PANEL_SRCPOS_X              0x7FFF          //0111 1111 1111 1111 14:0
#define ISP_BIT_PANEL_SRCPOS_Y              0x3FFF          //0011 1111 1111 1111 13:0
#define ISP_BIT_PANEL_SRC_WIDTH             0x7FFF          //0111 1111 1111 1111 14:0
#define ISP_BIT_PANEL_SRC_HEIGHT            0x3FFF          //0011 1111 1111 1111 13:0
...
// Multiple Output
//================================================================
#define ISP_REG_PREVIEWMODE_PARM            (ISP_REG_BASE + 0x010A)
...
//================================================================
#define ISP_REG_PVSCALE_HCI_L               (ISP_REG_BASE + 0x010C)   // HCI
#define ISP_REG_PVSCALE_HCI_H               (ISP_REG_BASE + 0x010E)   // HCI
#define ISP_REG_PVSCALE_VCI_L               (ISP_REG_BASE + 0x0110)   // VCI
#define ISP_REG_PVSCALE_VCI_H               (ISP_REG_BASE + 0x0112)   // VCI

#define ISP_BIT_PVSCALE_L                   0xFFFF          //1111 1111 1111 1111 15:0
#define ISP_BIT_PVSCALE_H                   0x000F          //0000 0000 0000 1111 3:0
