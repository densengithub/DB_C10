...
//#define ACCESS_REG_DIRECT

// CMDQ BUFFER LEN
#define CMDQ_BUF_NUM                        512
...
#define ISP_SCALE_MAX_LINE_BUFF_LEN_NORMAL  1280
#define ISP_SCALE_MAX_LINE_BUFF_LEN_PREVIEW 640
...
typedef enum ISP_FLAGS_UPDATE_TAG
{
    ...
    ISP_FLAGS_UPDATE_PreviewMode      = (0x00000001 << 25),
    ISP_FLAGS_UPDATE_PVScaleParam     = (0x00000001 << 26),
    ISP_FLAGS_UPDATE_PVScaleMatrixH   = (0x00000001 << 27),
    ISP_FLAGS_UPDATE_PVScaleMatrixV   = (0x00000001 << 28),
    ISP_FLAGS_UPDATE_PVOutParameter   = (0x00000001 << 29),
    ISP_FLAGS_UPDATE_PVOutBufInfo     = (0x00000001 << 30),
    ISP_FLAGS_UPDATE_PVOutAddress     = (0x00000001 << 31),
} ISP_FLAGS_UPDATE;
...
typedef enum ISP_FLAGS_WORK_TAG
{
    ...
    ISP_FLAGS_CAP_ONFLY_INIT          = (0x00000001 << 3),
    ISP_FLAGS_ENABLE_CMDQ             = (0x00000001 << 4),
    ISP_FLAGS_INTERRUPT_INIT          = (0x00000001 << 5),
    ISP_FLAGS_QUEUE_FIRE_INIT         = (0x00000001 << 6),
    ISP_FLAGS_ENABLE_ONFLY_UPDATEFLAG = (0x00000001 << 7),
    ISP_FLAGS_ENABLE_MOTION_DETECTION = (0x00000001 << 8),
    ISP_FLAGS_ENABLE_ISR_FIRE         = (0x00000001 << 9),
    ISP_FLAGS_ENABLE_LOW_LATENCY      = (0x00000001 << 10)
} ISP_FLAGS_WORK;
...
{
    DEINTER3D = MMP_ISP_3D_DEINTERLACE,
    DEINTER2D = MMP_ISP_2D_DEINTERLACE
} ISP_DEINTER_MODE;
...
typedef struct ISP_ENGINE_MODE_CTRL_TAG
{
    ...
    MMP_BOOL   EnableCaptureOnFly;
    MMP_BOOL   EnableJPEGDECODE;
    MMP_BOOL   EnableLOWLATENCY;
...
typedef struct ISP_OUTPUT_INFO_TAG
{
    ...
    MMP_BOOL              ClearInterrupt;
    MMP_UINT16            WrFlipNum;
    ...
    MMP_UINT16            PitchUV;
    MMP_BOOL              EnableOutputFieldMode;
    MMP_UINT16            LOWLATENCYSliceNum;
    MMP_UINT16            Reserved;
    //ISP_PIXEL_FORMAT        Format;
} ISP_OUTPUT_INFO;

//Preview output
typedef struct ISP_PV_OUTPUT_INFO_TAG
{
    MMP_BOOL              DitherMode;
    ISP_OUT_FORMAT        OutFormat;
    ISP_OUT_RGB_FORMAT    RGBFormat;
...
typedef struct ISP_CONTEXT_TAG
{
    ...
    //WeightMatInt table only need to be cacluated once at initial time.
    ...
    //CMDQ Buffer
    struct ISP_HW_OPERATION *gptIspHwOp;
    MMP_UINT8               CMDQ_BUF[CMDQ_BUF_NUM];

    //ISP ISR Fire
    MMP_BOOL                EnableISRFire;
} ISP_CONTEXT;
