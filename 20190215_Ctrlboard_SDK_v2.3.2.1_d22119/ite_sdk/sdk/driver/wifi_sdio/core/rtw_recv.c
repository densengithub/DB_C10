...
//#define DISPLAY_5G_BITRATE
#ifdef DISPLAY_5G_BITRATE
static int gReceive = -1;
...
void count_rx_stats(_adapter *padapter, union recv_frame *prframe, struct sta_info*sta)
{
	...
	padapter->mlmepriv.LinkDetectInfo.NumRxOkInPeriod++;
        ...
        if (itpTimevalDiff(&tv1, &tv2)>4000){
            // (gReceive/4000)*8 == (gReceive/500)
            printf("Rtl 2.4G rx %d kbps \n",(gReceive/500));
            gReceive=0;
            gettimeofday(&tv1, NULL);
        }
#endif
