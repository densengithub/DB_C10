...
void VHT_caps_handler(_adapter *padapter, PNDIS_802_11_VARIABLE_IEs pIE)
{
	...
	pvhtpriv->ampdu_len = GET_VHT_CAPABILITY_ELE_MAX_MPDU_LENGTH(pIE->data); //eason edit
	printf("=======>pIE->data: %hhu %u\n", pIE->data, GET_VHT_CAPABILITY_ELE_MAX_MPDU_LENGTH(pIE->data));
