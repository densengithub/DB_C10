	...
	)
{
	...
	p_dm_psd_table->rf_0x18_bkp_b = odm_get_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x18, RFREGOFFSETMASK);
	...
	/* RF path-b */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x18, 0xff, psd_fc_channel);     /* Set RF fc*/
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x18, 0x300, rf_reg18_9_8);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x18, 0xc00, p_dm_psd_table->psd_bw_rf_reg);     /*2b'11: 20MHz, 2b'10: 40MHz, 2b'01: 80MHz */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x18, 0xf0000, ag_rf_mode_reg);     /* Set RF ag fc mode*/
	...
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_B, 0x18, RFREGOFFSETMASK, p_dm_psd_table->rf_0x18_bkp_b);
