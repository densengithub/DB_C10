...
void smTimerCtrlProc(void *p)
{
    ...
    printf("iteTimerCtrlTerminate end\n");
    SYS_DelEvent(timer_event);
    /* Clear all timer */
...
int iteTimerCtrlTerminate(void) 
{
    ...
    SYS_SetEvent(timer_event);
   	...
   	if (timerCtrl->timerTask > 0) 
   	{
        ...
        printf("iteTimerCtrlTerminate timerTask <=0 %d\n",timerCtrl->timerTask > 0);
