...
#define HWCFGAddress64Bits     0x80000000
#define HWCFGDnfSupport        0x40000000
#define HWCFGRfcSupport        0x30000000
#define HWCFGQEnhanceSupport   0x08000000
#define HWCFGInstantSupport    0x04000000
#define HWCFGSvctSupport       0x02000000
#define HWCFGAxiIdInSupport    0x01000000
#define HWCFGIrqClearSupport   0x00800000
#define HWCFGInLoopbackSupport 0x00400000
...
/* Hardware configuration description */
    typedef struct EWLHwConfig
    {
        ...
        u32 rfcSupport;     /* HW supports reference framce compression */
