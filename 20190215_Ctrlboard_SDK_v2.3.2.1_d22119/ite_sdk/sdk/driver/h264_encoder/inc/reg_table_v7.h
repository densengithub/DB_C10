...
/* Reference Frame Compression */
    ...
    H1REG(HEncRfcChrBufLimit      , 0x690, 0xfffff000, 12, 0, RW, "Limit of chroma RFC buffer in unit of 64-bit. 0 indicating no limit. Send an IRQ if overflow."),
