...
ithPixelPlusSetEffectDefault(
    void)
{
    ithPixelPlusSetBrightness(0x0);
    ithPixelPlusSetContrast(0x45);
    ithPixelPlusSetSaturation(0x2a);
    ithPixelPlusSetSharpness(0x14);
}
