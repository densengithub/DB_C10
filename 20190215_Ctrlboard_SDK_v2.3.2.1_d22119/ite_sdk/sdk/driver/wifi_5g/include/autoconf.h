...
//eason add
#define CONFIG_USB_HCI	1 //device interface type
#define PLATFORM_LINUX	1 //platform type
#define CONFIG_RTL8821A 1 //driver type(usb2.0) referance to usb_intf.c #rtw_usb_id_tbl[]
