...
void itp_codec_playback_init(unsigned output)
{
    ...
    /* digital volume zero-cross control */
    {
        ...
        data16  = reg_read16(I2S_REG_FADE_IN_OUT_CTRL); /* 0x1666 */
        data16 |= (1 << 12);
        data16 |= (0xF << 8);                      /* fading_step */
        data16 |= (0x01 & 0xFF);                   /* fading_duration */
        reg_write16(I2S_REG_FADE_IN_OUT_CTRL, data16);
...
//		data16 = reg_read16(I2S_REG_DIG_OUT_VOL); /* 0x1668 */
//		data16 &= ~(0x7F << 9);
//		data16 |=  (0x0F << 9);
//		reg_write16(I2S_REG_DIG_OUT_VOL, data16);
//
//		/* crossing threshold */
...
void itp_codec_playback_mute(void)
{
    /* digital mute */
    {
        u16 data16 = reg_read16(I2S_REG_DIG_OUT_VOL); /* 0x1668 */
        data16 &= ~(0x1FF);
        data16 |= (0x000);
        reg_write16(I2S_REG_DIG_OUT_VOL, data16);
    }
...
void itp_codec_rec_set_direct_volperc(int target_recperc)
{
