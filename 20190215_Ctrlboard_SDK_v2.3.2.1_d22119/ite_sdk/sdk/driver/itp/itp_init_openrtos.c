...
static const char *dbgFlag[] = {
    ...
    #elif (CFG_CHIP_FAMILY == 970 || CFG_CHIP_FAMILY == 960)
...
void itpInit(void)
{
    ...
    // init risc2 cpu
#ifdef CFG_RISC2_ENABLE
    itpRegisterDevice(ITP_DEVICE_RISC2, &itpDeviceRisc2);
#endif
    ...
    ioctl(ITP_DEVICE_UART4, ITP_IOCTL_RESET, (void *)CFG_UART4_BAUDRATE);
#endif

    //init uart5 device
#if defined(CFG_UART5_ENABLE) && !defined(CFG_DBG_UART5)
    itpRegisterDevice(ITP_DEVICE_UART5, &itpDeviceUart5);
    ioctl(ITP_DEVICE_UART5, ITP_IOCTL_RESET, (void *)CFG_UART5_BAUDRATE);
#endif
    ...
    ioctl(ITP_DEVICE_RS485_4, ITP_IOCTL_INIT,  ITH_UART_NONE);
    ioctl(ITP_DEVICE_RS485_4, ITP_IOCTL_ON,    (void *)&RS485_port4);
    ioctl(ITP_DEVICE_RS485_4, ITP_IOCTL_RESET, NULL);
#endif

    // init RS485_5 device
#if defined(CFG_RS485_5_ENABLE)
    ITHRS485Port RS485_port5 = ITH_RS485_5;
    itpRegisterDevice(ITP_DEVICE_RS485_5, &itpDeviceRS485_5);
    ioctl(ITP_DEVICE_RS485_5, ITP_IOCTL_INIT,  ITH_UART_NONE);
    ioctl(ITP_DEVICE_RS485_5, ITP_IOCTL_ON,    (void *)&RS485_port5);
    ioctl(ITP_DEVICE_RS485_5, ITP_IOCTL_RESET, NULL);
#endif
