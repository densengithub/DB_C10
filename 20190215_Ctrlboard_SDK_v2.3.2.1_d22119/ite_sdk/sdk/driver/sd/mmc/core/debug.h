...
#if PR_REG
#define pr_reg(string, ...)   do { printf("[SD] "); printf(string, __VA_ARGS__); } while (0)
#else
#define pr_reg(string, ...)
#endif
...
#if PR_REG
#define pr_reg(string, args...)   do { ithPrintf("[SD] "); ithPrintf(string, ## args); } while (0)
#else
#define pr_reg(string, args...)
#endif
