...
static void SetPadSel(uint32_t port)
{
    ...
    ithWriteRegMaskA(ITH_GPIO_BASE + ITH_GPIO_MISC_SET_REG, 0x4 << ITH_GPIO_HOST_SEL_POS, ITH_GPIO_HOST_SEL_MSK);//Host_sel
#endif
    ithGpioSetMode( ITH_GPIO_PIN2,  ITH_GPIO_MODE1);
    ithGpioSetMode( ITH_GPIO_PIN3,  ITH_GPIO_MODE1);
    ithGpioSetMode( ITH_GPIO_PIN6,  ITH_GPIO_MODE1);
}
