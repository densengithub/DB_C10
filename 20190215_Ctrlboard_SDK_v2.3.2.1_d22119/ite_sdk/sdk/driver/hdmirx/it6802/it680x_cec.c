...
//******************************************/
#include "stdio.h"
#include "hdmirx/it6802/it680x_cec.h"
...
unsigned char UICommandCode;

u8_t StandbyState;

CEC_FRAME TxCmdBuf;
unsigned short	CMDCount=0;
...
#if	0
//FOR IT6802+iT6623
unsigned char xdata VSDB_Addr;
unsigned char xdata txphyadr[2], txphyA, txphyB, txphyC, txphyD, txphylevel;
unsigned char xdata rxphyadr[4][2];
unsigned char xdata rxphyA, rxphyB, rxphyC, rxphyD, rxcurport;
#else
extern unsigned char xdata VSDB_Addr;
extern unsigned char xdata txphyadr[2], txphyA, txphyB, txphyC, txphyD, txphylevel;
extern unsigned char xdata rxphyadr[2][2];
extern unsigned char xdata rxphyA, rxphyB, rxphyC, rxphyD, rxcurport;
#endif
...
unsigned char cec_cnt100ms(void)
{

    unsigned char  T100us=0;
    unsigned char uc;
...
{
unsigned char reg0x44;
unsigned char ReadyFire, BusFree;
...
// for IT6802+iT6623void CEC_InactiveSource(unsigned char port)
// for IT6802+iT6623{
// for IT6802+iT6623
...
// for IT6802+iT6623void CEC_RoutingChange(unsigned char port)
// for IT6802+iT6623 {
// for IT6802+iT6623	//when Source un-plug(w/o +5v ) then broadcast AVR routing change.
// for IT6802+iT6623
// for IT6802+iT6623	unsigned char	adr0,adr1;
// for IT6802+iT6623
...
BOOL CheckUpDownPhyAdr(void)
{
    u8_t i;
    BOOL Result=FALSE;
    unsigned char pA,pB,pC,pD,MyLevel,TargetLevel;
...
// for IT6802+iT6623					t_IIC_Buffer.I2cRegisterMap.CEC_Audio_Status=(unsigned char)uCECAudioStatus.Map.AudioVolumeStatus;
