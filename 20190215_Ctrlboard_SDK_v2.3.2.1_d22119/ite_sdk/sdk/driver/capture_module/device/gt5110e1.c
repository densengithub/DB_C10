...
static bool             gGT5110E1InitDone   = MMP_FALSE;
...
uint16_t GT5110E1GetProperty(MODULE_GETPROPERTY property)
{
	switch(property)
	{
	 ...
	 case GetModuleIsInterlace:
	    ...
	    break;
	 case FrameRate:
	 	return GT5110E1_TABLE[0].FrameRate;
	    break;
     case matchResolution:
	 	return MMP_TRUE;
	    break;
	 case HPolarity:
	 	return GT5110E1_TABLE[0].HPolarity;
	 	break;
	 case VPolarity:
	 	return GT5110E1_TABLE[0].VPolarity;
	 	break;
	 case HStar:
	 	return GT5110E1_TABLE[0].HStar;
	 	break;
	 case HEnd:
	 	return GT5110E1_TABLE[0].HEnd;
	 	break;
	 case VStar1:
	 	return GT5110E1_TABLE[0].VStar1;
	 	break;
	 case VEnd1:
	 	return GT5110E1_TABLE[0].VEnd1;
	 	break;
	 case VStar2:
	 	return GT5110E1_TABLE[0].VStar2;
	 	break;
	 case VEnd2:
	 	return GT5110E1_TABLE[0].VEnd2;
	 	break;
	 default:
        return 0;
		break;
...
void GT5110E1SetProperty(MODULE_SETPROPERTY Property, uint16_t Value)
{
}
