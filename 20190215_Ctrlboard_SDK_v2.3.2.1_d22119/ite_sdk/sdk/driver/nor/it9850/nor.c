...
typedef struct
{
    ...
    // Operation
    bool use3BytesModeForce;
    bool use4BytesAddress;
    bool use4BytesAddressOldCMD;
}NOR_ADDR_CONTEXT;
...
NOR_VENDOR_CONTEXT nor_support_vendor[] = {
    ...
    {0x20, 0x7018, 0x17, "XTX_PN25F128A",   XTX_PN25F128A},
    ...
    {0xEF, 0x4019, 0x18, "WIN_W25Q256FVFQ", WIN_W25Q256FVFQ}
};
    ...
    NOR_VENDOR_CONTEXT* context)
{
    switch(context->vendorID)
    {
        ...
        case MX_25L25735F:
            ...
            norObject->context.use3BytesModeForce     = true;
        ...
        case WIN_W25Q256FVFQ:  // 32 MB
            ...
            norObject->context.totalBlocks            = 512;
            norObject->context.use4BytesAddress       = true;
            norObject->context.use4BytesAddressOldCMD = true;
        break;
    ...
    uint32_t		outDataBufferSize)
{
    ...
    case ERASE_SECTOR:
        ...
        if (norObject->context.use4BytesAddress == true &&
                norObject->context.use4BytesAddressOldCMD == false)
        {
	...
	SPI_CSN  chipSelectPin)
{
	...
	if (norObject->refCount == 0)
	{
        ...
        if (foundId == true)
        {
            ...
            if (!norObject->context.use3BytesModeForce && norObject->context.use4BytesAddress)
            {
