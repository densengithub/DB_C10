			      ...
			      t_u32 respbuflen)
{
	...
	if (usb_resubmit_urbs) {
		...
		/* Rx SG parameters has changed or disabled, kill the URBs,
		   they will be resubmitted after saving the parameters to USB
		   card */
 ...
 */
static int
woal_priv_enter_usb_suspend(moal_private * priv, t_u8 * respbuf,
			    t_u32 respbuflen)
{
	int ret = 0;
 ...
 */
static int
woal_priv_exit_usb_suspend(moal_private * priv, t_u8 * respbuf,
			   t_u32 respbuflen)
{
	int ret = 0;
