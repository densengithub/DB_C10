...
struct net_device *rtw_init_netdev(_adapter *old_padapter)	
{
	...
	pnetdev = alloc_netdevice(sizeof(_adapter)); //James Modify : Have set Name in this api
...
//#if (LINUX_VERSION_CODE>=KERNEL_VERSION(2,6,29))
	...
	//pnetdev->get_wireless_stats = rtw_get_wireless_stats; //James Add 
	pnetdev->wireless_control = rtw_ioctl_smCtrl;      /*Set behavior*/ //James Add
    pnetdev->wireless_information = rtw_ioctl_smInfo;  /*Get behavior*/	 //James Add
#endif
