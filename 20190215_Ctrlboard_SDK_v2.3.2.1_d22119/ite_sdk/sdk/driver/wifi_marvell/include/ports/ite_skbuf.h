...
typedef struct netlink_skb_parms netlink_skb_parms_t;
 ...
 */
static inline u32_t skb_queue_len(const struct sk_buff_head *list_)
{
	return list_->qlen;
}
