...
static inline u8* _linux_vmalloc(u32 sz)
{
	u8 	*pbuf = NULL;
#ifdef PLATFORM_LINUX	
	pbuf = vmalloc(sz);
...
static inline u8* _linux_zvmalloc(u32 sz)
{
	u8 	*pbuf = NULL;
...
static inline void _linux_vmfree(u8 *pbuf, u32 sz)
{
#ifdef	PLATFORM_LINUX
	vfree(pbuf);
#endif	
...
static inline struct sk_buff *_linux_skb_alloc(u32 sz)
{
#ifdef PLATFORM_LINUX
...
static inline void _linux_skb_free(struct sk_buff *skb)
{
...
static inline u32 _linux_systime_to_ms(u32 systime)
{
...
static inline u32 _linux_ms_to_systime(u32 ms)
{
...
static inline void _linux_ATOMIC_SET(ATOMIC_T *v, int i)
{
	#ifdef PLATFORM_LINUX
	atomic_set(v,i);
	#endif
...
static inline int _linux_ATOMIC_READ(ATOMIC_T *v)
{
	#ifdef PLATFORM_LINUX
...
static inline void _linux_ATOMIC_ADD(ATOMIC_T *v, int i)
{
	#ifdef PLATFORM_LINUX
	atomic_add(i,v);
	#endif
}
static inline void _linux_ATOMIC_SUB(ATOMIC_T *v, int i)
{
	#ifdef PLATFORM_LINUX
	atomic_sub(i,v);
	#endif
...
static inline void _linux_ATOMIC_INC(ATOMIC_T *v)
{
	#ifdef PLATFORM_LINUX
	atomic_inc(v);
	#endif
...
static inline void _linux_ATOMIC_DEC(ATOMIC_T *v)
{
	#ifdef PLATFORM_LINUX
	atomic_dec(v);
	#endif
...
static inline int _linux_ATOMIC_ADD_RETURN(ATOMIC_T *v, int i)
{
	#ifdef PLATFORM_LINUX
...
static inline int _linux_ATOMIC_SUB_RETURN(ATOMIC_T *v, int i)
{
	#ifdef PLATFORM_LINUX
...
static inline int _linux_ATOMIC_INC_RETURN(ATOMIC_T *v)
{
	#ifdef PLATFORM_LINUX
...
static inline int _linux_ATOMIC_DEC_RETURN(ATOMIC_T *v)
{
	#ifdef PLATFORM_LINUX
